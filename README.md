...
Hello World, I’m Daman. A highly motivated software developer pursuing Master of Engineering at [Carleton University][carleton]. Before going back to school to start my journey towards the graduate degree, I studied [Computer Systems Technician][cst] at [Algonquin College][algonquin] where I used to hack around cisco routers & switches, and had the opportunity to work as a Technology Intern as well as a full time Software Engineer in Cloud And Cognitive Support vertical of [IBM Canada][ibm]. Other than that...
</p>

- :sunflower:  In my free time, I like giving back to the developer community by contributing to [![Open Source Love](https://badges.frapsoft.com/os/v1/open-source.svg?v=103)](https://github.com/ellerbrock/open-source-badges/) projects in my free time. Notably [Kubernetes][kubernetes].
